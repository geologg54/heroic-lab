// components/catalog/MobileCatalogView.tsx
'use client'
...
// Локальный компонент секции фильтра для мобильной версии
    ...
    <div className="border-b border-borderLight pb-3">
      ...
      >
        <span>
          ...
          {selected.length > 0 && !isExpanded && (
            <span className="ml-1 text-accent text-sm">выбрано: {selected.length}</span>
          )}
        </span>
      ...
      {isExpanded && (
        <div className="mt-2 space-y-2">
          {isEmpty && isTagsSection ? (
            <p className="text-gray-400 text-sm px-1">
              Для отображения тегов выберите категорию
            </p>
          ) : (
            <>
        ...
        <div className="grid grid-cols-3 items-center">
          ...
          <div className="justify-self-center flex items-center gap-2">
            ...
            <button
              ...
              className="text-white border-[1.5px] border-white rounded-full p-1.5 focus:outline-none"
            >
              <ChevronUp size={16} />
              <ChevronDown size={16} />
            </button>
