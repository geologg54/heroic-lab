...
export default function Footer() {
  return (
    <footer className="bg-[#05192C] border-t border-[#1e3a5f] py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-bold mb-4">Героическая лаборатория</h3>
            <p className="text-sm text-gray-400">Цифровые 3D-модели для настольных игр</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/delivery">Доставка (цифровая)</Link></li>
        ...
        <div className="text-center text-xs text-gray-500 mt-8 pt-4 border-t border-[#1e3a5f]">
          © 2025 Героическая лаборатория миниатюр. Все модели — цифровые файлы для 3D печати.
        </div>
      </div>
    </footer>
  )
